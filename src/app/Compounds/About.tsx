...
function __OriginkitBase_ScrollHighlight({
...
const __originkitPresetProps = {
  "text": "I'm Abdullah, a passionate Full-Stack Developer dedicated to building modern, scalable, and user-centric web applications. With a strong command of both frontend and backend technologies, I handle everything from pixel-perfect UI design to secure database integration. Let's build something amazing together.",
  "dimColor": "rgba(255, 255, 255, 0.15)",
  "highlightColor": "#FFFFFF",
  "splitBy": "words",
  "scrollStart": "top center",
...
export default function ScrollHighlight(props: Record<string, unknown>) {
  return <__OriginkitBase_ScrollHighlight {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}